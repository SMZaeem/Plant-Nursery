        ...
        <div>
            <div className="navbar" style={styleObj}>
                <div className="tag">
                    <div className="luxury">
                        ...
                        <a href="/" onClick={(e) => handleHomeClick(e)}>
                            <div>
                                <h3 style={{ color: 'white' }}>Plant Nursery</h3>
                                <i style={{ color: 'white' }}>Where You Meet Nature</i>
                            </div>
                        </a>
                    </div>
              ...
              style={{
                ...
                marginLeft: '10px',
                marginTop: '25px',
                // backgroundColor: 'none', // Style as a badge
                color: 'white',
                borderRadius: '50%',
                padding: '4px 8px',
                fontSize: '20px',
            ...
            {!showCart ? (
                <div className="product-grid">
                        {plantsArray.map((category, index) => (
                            <div key={index}>
                                <h1 className='category-heading'><div>{category.category}</div></h1>
                                <div className="product-list">
                                    ...
                                    <div className="product-card" key={plantIndex}>
                                        ...
                                        <button disabled={addedToCart[plant.name]} className={addedToCart[plant.name]?"product-button added-to-cart":"product-button"} onClick={() => handleAddToCart(plant)}>Add to Cart</button>
                                    </div>
                                    ))}
                                </div>
                            </div>
                ...
                <CartItem onContinueShopping={handleContinueShopping} setAddedToCart={setAddedToCart} setNumberOfCartItems={setNumberOfCartItems}/>
            )}
        </div>
    );
}
